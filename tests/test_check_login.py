...
class TestStellarBurgers:
    def test_login(self, driver, logged_user, wait_for_element_located):
        ...
        wait_for_element_located(driver, time=17, locator=Locators.LOGOUT_BUTTON, condition=EC.presence_of_element_located)
